...
class MaintenancePortalController(Portal2):
    ...
    def portal_my_requests(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, **kw):
        ...
        searchbar_sortings = {
            ...
            "priority": {"label": _("Prioridad"), "order": "maintenance_priority_id desc"},
        }
    ...
    def portal_my_request(self, maintenance_id=None, **kw):
        ...
        prioridad = request.env["maintenance.maintenance_priority"].search([])
    ...
    def submit_ticket(self, **kw):
        ...
        vals = {
          ...
          "maintenance_priority_id": kw.get("prior"),

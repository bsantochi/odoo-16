...
class MaintenanceEquipment(models.Model):
    ...
    def _prepare_request_from_plan(self, maintenance_plan, next_maintenance_date):
        vals = super(MaintenanceEquipment, self)._prepare_request_from_plan(maintenance_plan, next_maintenance_date)
        vals['product_structure_ids'] = maintenance_plan.product_structure_ids
        return vals
